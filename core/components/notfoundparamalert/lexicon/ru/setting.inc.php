...
$_lang['setting_notfoundparamalert.alert_log_level_desc'] = 'Уровень логирования при записи сообщений в журнал ошибок. Доступные значения: "fatal", "error", "warn", "info", "debug".';
